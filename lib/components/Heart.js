...
class Heart extends Component {
  ...
  render() {
    ...
    return (<Button id='heart-button' height={sizes.square[size] + 5} width={sizes.square[size] + 5} onClick={this.handleClick}>
      <HeartIcon id='heart-icon' fill={colors[color]} width={sizes.square[size]}/>
    </Button>);
  }
